...
const TESTIMONIALS = [
  {
    companyLogoUrl: '/rate.png',
    content: `Rebucom transformed our logistics operations. Their expertise and dedication to our success are unparalleled.`,
    author: {
      name: 'Leslie Alexander',
      title: 'Founder',
      avatarUrl: '/testimonials/user1.png',
    },
  },
  {
    companyLogoUrl: '/rate.png',
    content: `Efficiency, reliability, and cost savings – Rebucom delivers on all fronts. Highly recommended!`,
    author: {
      name: 'Jacob Jones',
      title: 'Co-Founder',
      avatarUrl: '/testimonials/user2.png',
    },
  },
  {
    companyLogoUrl: '/rate.png',
    content: `Rebucom's solutions streamlined our operations, reduced costs, and improved efficiency essential for our success.`,
    author: {
      name: 'Marjorie Morgan',
      title: 'Chief Marketing Officer',
      avatarUrl: '/testimonials/user3.png',
    },
  },
];
...
export default function Testimonials() {
  return (
    <div>
      <h1 style={{ textAlign: 'center', paddingBottom: '60px', fontSize: '35px' }}>What our customers are saying</h1>
      <TestimonialsWrapper>
